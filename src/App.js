...
import TribeLogo from './TribeofNoise.png'
...
function App({ getString }) {    
    ...
    const handleDownload = useCallback(() => {
        ...
        img.onload = function () {
            ...
            .then(b64 => {
                ...
                trigger_download('tribe-profile-picture.png', b64)
            })
    ...
    return (
        <div className="App" {...getRootProps()}>
            <img src={TribeLogo} className="HeaderImage" alt={getString('alt_tribe_logo')} />
            ...
            <footer>
                ...
                &nbsp; • &nbsp;*/}
                <a href="https://www.tribeofnoise.com/pages/privacy">
                    <Localized id="link_privacy_policy" />
                </a>
                &nbsp; • &nbsp;
                <a href="https://github.com/tribeofnoise/profile-pic-generator">
